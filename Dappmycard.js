 var userAccount;
  ...
  <strong>Please!</strong> Unlock your Metamask wallet and refresh the page.
          ...
          if (result !== userAccount) {
            ...
            userAccount = result;
			            cryptovideogamestoken.methods.balanceOf(userAccount.toString(10)).call(function (err, result) {
						
                    document.getElementById("info").innerHTML = ''; 
                    
                   if (result == 0) {
                       document.getElementById("info").innerHTML = `<div class="alert info">
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <strong>Info!</strong> This user does not have XGAME.
If you have already purchased an XGAME, try updating this page later or visit the <b style='color:blue'>MarketPlace</b> to buy one.
</div>`;      
					 
                   }
                
            document.getElementById("addressOwner").innerHTML = `You have: <b>${result} XGAME<b>`;
...
(function priceOf14 () {
           ...
           cryptovideogamestoken.methods.priceOf(14).call(function (err, result) {//ejemplo precio token #14
                $("#price14").text(result);
...
(function priceOf35 () {
          ...
          cryptovideogamestoken.methods.priceOf(35).call(function (err, result) {//ejemplo precio token #35
                $("#price35").text(result);
...
// NextPriceOf Sub Zero TokenId #12
 ...
 // NextPriceOf The Witcher TokenId #31
        (function nextPriceOf31 () {
          ...
          cryptovideogamestoken.methods.nextPriceOf(31).call(31,function (err, result) {//ejemplo Próximo precio token #31
...
// NextPriceOf Pagan Mind TokenId #32
        (function nextPriceOf32 () {
          ...
          cryptovideogamestoken.methods.nextPriceOf(32).call(32,function (err, result) {//ejemplo Próximo precio token #32
...
// NextPriceOf Lara Croft TokenId #35
   ...
   // OwnerOf Mario Bross TokenId #0
         ...
         (function ownerOf () {
          ...
          document.getElementById("ownermycard").innerHTML = `${result}`;
...
(function ownerOf1 () {
         ...
         document.getElementById("ownermycard1").innerHTML = `${result}`;
     }); 
...
(function ownerOf2 () {
            ...
            cryptovideogamestoken.methods.ownerOf(2).call(function (err, result) {//ejemplo dueño del token #2
          $("#owner").text(result);
           var rec = result.substring(0,12);
           document.getElementById("ownerCard2").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
         document.getElementById("ownermycard2").innerHTML = `${result}`;
     }); 
...
(function ownerOf3 () {
         ...
         document.getElementById("ownermycard3").innerHTML = `${result}`;
     }); 
...
(function ownerOf4 () {
         ...
         document.getElementById("ownermycard4").innerHTML = `${result}`;
     }); 
...
(function ownerOf5 () {
         ...
         document.getElementById("ownermycard5").innerHTML = `${result}`;
     }); 
...
(function ownerOf6 () {
         ...
         document.getElementById("ownermycard6").innerHTML = `${result}`;
     }); 
...
(function ownerOf7 () {
         ...
         document.getElementById("ownermycard7").innerHTML = `${result}`;
     }); 
...
(function ownerOf8 () {
         ...
         document.getElementById("ownermycard8").innerHTML = `${result}`;
     }); 
...
(function ownerOf9 () {
         ...
         document.getElementById("ownermycard9").innerHTML = `${result}`;
     }); 
...
(function ownerOf10 () {
         ...
         document.getElementById("ownermycard10").innerHTML = `${result}`;
     }); 
...
(function ownerOf11 () {
         ...
         document.getElementById("ownermycard11").innerHTML = `${result}`;
     }); 
...
// OwnerOf Sub Zero TokenId #12
         ...
         (function ownerOf12 () {
          ...
          document.getElementById("ownermycard12").innerHTML = `${result}`;
...
(function ownerOf13 () {
         ...
         document.getElementById("ownermycard13").innerHTML = `${result}`;
     }); 
...
(function ownerOf14 () {
         ...
         document.getElementById("ownermycard14").innerHTML = `${result}`;
     }); 
...
(function ownerOf15 () {
         ...
         document.getElementById("ownermycard15").innerHTML = `${result}`;
     }); 
...
(function ownerOf16 () {
         ...
         document.getElementById("ownermycard16").innerHTML = `${result}`;
     }); 
...
(function ownerOf17 () {
         ...
         document.getElementById("ownermycard17").innerHTML = `${result}`;
     }); 
...
(function ownerOf18 () {
         ...
         document.getElementById("ownermycard18").innerHTML = `${result}`;
     }); 
...
(function ownerOf19 () {
         ...
         document.getElementById("ownermycard19").innerHTML = `${result}`;
     }); 
...
(function ownerOf20 () {
         ...
         document.getElementById("ownermycard20").innerHTML = `${result}`;
     }); 
...
(function ownerOf21 () {
          ...
          $("#owner").text(result);
           var rec = result.substring(0,12);
           document.getElementById("ownerCard21").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
         document.getElementById("ownermycard21").innerHTML = `${result}`;
     }); 
...
(function ownerOf22 () {
         ...
         document.getElementById("ownermycard22").innerHTML = `${result}`;
     }); 
...
(function ownerOf23 () {
         ...
         document.getElementById("ownermycard23").innerHTML = `${result}`;
     }); 
...
(function ownerOf24 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard24").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard24").innerHTML = `${result}`;
...
(function ownerOf25 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard25").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard25").innerHTML = `${result}`;
...
(function ownerOf26 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard26").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard26").innerHTML = `${result}`;
...
(function ownerOf27 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard27").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard27").innerHTML = `${result}`;
...
(function ownerOf28 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard28").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard28").innerHTML = `${result}`;
...
(function ownerOf29 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard29").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard29").innerHTML = `${result}`;
...
(function ownerOf30 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard30").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard30").innerHTML = `${result}`;
...
(function ownerOf31 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard31").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard31").innerHTML = `${result}`;
...
(function ownerOf32 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard32").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard32").innerHTML = `${result}`;
...
(function ownerOf33 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard33").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard33").innerHTML = `${result}`;
...
(function ownerOf34 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard34").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard34").innerHTML = `${result}`;
...
(function ownerOf35 () {
          ...
          $("#owner").text(result);
           ...
           document.getElementById("ownerCard35").innerHTML = `Owner: <a href="https://etherscan.io/address/${result}"><b style='color:blue'>${rec}...</b></a>`;
                document.getElementById("ownermycard35").innerHTML = `${result}`;
...
(function getToken36 () {
            ...
            cryptovideogamestoken.methods.getToken(36).call(function (err, result) {
                ...
                document.getElementById("nextprice36").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard36").innerHTML = `${result[3]}`;
     });
...
(function getToken37 () {
             ...
             cryptovideogamestoken.methods.getToken(37).call(function (err, result) {
                ...
                document.getElementById("nextprice37").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard37").innerHTML = `${result[3]}`;
     });
...
(function getToken38 () {
             ...
             cryptovideogamestoken.methods.getToken(38).call(function (err, result) {
                ...
                document.getElementById("nextprice38").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard38").innerHTML = `${result[3]}`;
     });
...
(function getToken39 () {
            ...
            cryptovideogamestoken.methods.getToken(39).call(function (err, result) {
                ...
                document.getElementById("nextprice39").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard39").innerHTML = `${result[3]}`;
     });
...
(function getToken40 () {
           ...
           cryptovideogamestoken.methods.getToken(40).call(function (err, result) {
                ...
                document.getElementById("nextprice40").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard40").innerHTML = `${result[3]}`;
     });
...
(function getToken41 () {
           ...
           cryptovideogamestoken.methods.getToken(41).call(function (err, result) {
                ...
                document.getElementById("nextprice41").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard41").innerHTML = `${result[3]}`;
     });
...
(function getToken42 () {
           ...
           cryptovideogamestoken.methods.getToken(42).call(function (err, result) {
                ...
                document.getElementById("nextprice42").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard42").innerHTML = `${result[3]}`;
     });
...
(function getToken43 () {
           ...
           cryptovideogamestoken.methods.getToken(43).call(function (err, result) {
                ...
                document.getElementById("nextprice43").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard43").innerHTML = `${result[3]}`;
     });
...
(function getToken44 () {
           ...
           cryptovideogamestoken.methods.getToken(44).call(function (err, result) {
                ...
                document.getElementById("nextprice44").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard44").innerHTML = `${result[3]}`;
     });
...
(function getToken45 () {
           ...
           cryptovideogamestoken.methods.getToken(45).call(function (err, result) {
                ...
                document.getElementById("nextprice45").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard45").innerHTML = `${result[3]}`;
     });
...
(function getToken46 () {
           ...
           cryptovideogamestoken.methods.getToken(46).call(function (err, result) {
                ...
                document.getElementById("nextprice46").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard46").innerHTML = `${result[3]}`;
     });
...
(function getToken47 () {
           ...
           cryptovideogamestoken.methods.getToken(47).call(function (err, result) {
                ...
                document.getElementById("nextprice47").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard47").innerHTML = `${result[3]}`;
     });
...
(function getToken48 () {
            ...
            cryptovideogamestoken.methods.getToken(48).call(function (err, result) {
                ...
                document.getElementById("nextprice48").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard48").innerHTML = `${result[3]}`;
     });
...
(function getToken49 () {
           ...
           cryptovideogamestoken.methods.getToken(49).call(function (err, result) {
                ...
                document.getElementById("nextprice49").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard49").innerHTML = `${result[3]}`;
     });
...
(function getToken50 () {
            ...
            cryptovideogamestoken.methods.getToken(50).call(function (err, result) {
                ...
                document.getElementById("nextprice50").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard50").innerHTML = `${result[3]}`;
     });
...
(function getToken51 () {
           ...
           cryptovideogamestoken.methods.getToken(51).call(function (err, result) {
                ...
                document.getElementById("nextprice51").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard51").innerHTML = `${result[3]}`;
     });
...
(function getToken52 () {
            ...
            cryptovideogamestoken.methods.getToken(52).call(function (err, result) {
                ...
                document.getElementById("nextprice52").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard52").innerHTML = `${result[3]}`;
     });
...
(function getToken53 () {
            ...
            cryptovideogamestoken.methods.getToken(53).call(function (err, result) {
                ...
                document.getElementById("nextprice53").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard53").innerHTML = `${result[3]}`;
     });
...
(function getToken54 () {
            ...
            cryptovideogamestoken.methods.getToken(54).call(function (err, result) {
                ...
                document.getElementById("nextprice54").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard54").innerHTML = `${result[3]}`;
     });
...
(function getToken55 () {
            ...
            cryptovideogamestoken.methods.getToken(55).call(function (err, result) {
                ...
                document.getElementById("nextprice55").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard55").innerHTML = `${result[3]}`;
     });
...
(function getToken56 () {
            ...
            cryptovideogamestoken.methods.getToken(56).call(function (err, result) {
                ...
                document.getElementById("nextprice56").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard56").innerHTML = `${result[3]}`;
     });
...
(function getToken57 () {
            ...
            cryptovideogamestoken.methods.getToken(57).call(function (err, result) {
                ...
                document.getElementById("nextprice57").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard57").innerHTML = `${result[3]}`;
     });
...
(function getToken58 () {
           ...
           cryptovideogamestoken.methods.getToken(58).call(function (err, result) {
                ...
                document.getElementById("nextprice58").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard58").innerHTML = `${result[3]}`;
     });
...
(function getToken59 () {
          ...
          cryptovideogamestoken.methods.getToken(59).call(function (err, result) {
                ...
                document.getElementById("nextprice59").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard59").innerHTML = `${result[3]}`;
     });
            
		})();
// Get Duck Hunt Dog TokenId #60
(function getToken60 () {
           ...
           cryptovideogamestoken.methods.getToken(60).call(function (err, result) {
                ...
                document.getElementById("nextprice60").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard60").innerHTML = `${result[3]}`;
     });
...
(function getToken61 () {
           ...
           cryptovideogamestoken.methods.getToken(61).call(function (err, result) {
                ...
                document.getElementById("nextprice61").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard61").innerHTML = `${result[3]}`;
     });
...
(function getToken62 () {
           ...
           cryptovideogamestoken.methods.getToken(62).call(function (err, result) {
                ...
                document.getElementById("nextprice62").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard62").innerHTML = `${result[3]}`;
     });
...
(function getToken63 () {
            ...
            cryptovideogamestoken.methods.getToken(63).call(function (err, result) {
                ...
                document.getElementById("nextprice63").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard63").innerHTML = `${result[3]}`;
     });
...
(function getToken64 () {
           ...
           cryptovideogamestoken.methods.getToken(64).call(function (err, result) {
                ...
                document.getElementById("nextprice64").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard64").innerHTML = `${result[3]}`;
     });
...
(function getToken65 () {
           ...
           cryptovideogamestoken.methods.getToken(65).call(function (err, result) {
                ...
                document.getElementById("nextprice65").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard65").innerHTML = `${result[3]}`;
     });
...
(function getToken66 () {
           ...
           cryptovideogamestoken.methods.getToken(66).call(function (err, result) {
                ...
                document.getElementById("nextprice66").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard66").innerHTML = `${result[3]}`;
     });
...
(function getToken67 () {
           ...
           cryptovideogamestoken.methods.getToken(67).call(function (err, result) {
                ...
                document.getElementById("nextprice67").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard67").innerHTML = `${result[3]}`;
     });
...
(function getToken68 () {
           ...
           cryptovideogamestoken.methods.getToken(68).call(function (err, result) {
                ...
                document.getElementById("nextprice68").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard68").innerHTML = `${result[3]}`;
     });
...
(function getToken69 () {
           ...
           cryptovideogamestoken.methods.getToken(69).call(function (err, result) {
                ...
                document.getElementById("nextprice69").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard69").innerHTML = `${result[3]}`;
     });
...
(function getToken70 () {
           ...
           cryptovideogamestoken.methods.getToken(70).call(function (err, result) {
                ...
                document.getElementById("nextprice70").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard70").innerHTML = `${result[3]}`;
     });
...
(function getToken71 () {
            ...
            cryptovideogamestoken.methods.getToken(71).call(function (err, result) {
                ...
                document.getElementById("nextprice71").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard71").innerHTML = `${result[3]}`;
     });
...
(function getToken72 () {
            ...
            cryptovideogamestoken.methods.getToken(72).call(function (err, result) {
                ...
                document.getElementById("nextprice72").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard72").innerHTML = `${result[3]}`;
     });
...
(function getToken73 () {
           ...
           cryptovideogamestoken.methods.getToken(73).call(function (err, result) {
                ...
                document.getElementById("nextprice73").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard73").innerHTML = `${result[3]}`;
     });
...
(function getToken74 () {
           ...
           cryptovideogamestoken.methods.getToken(74).call(function (err, result) {
                ...
                document.getElementById("nextprice74").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard74").innerHTML = `${result[3]}`;
     });
...
(function getToken75 () {
           ...
           cryptovideogamestoken.methods.getToken(75).call(function (err, result) {
                ...
                document.getElementById("nextprice75").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard75").innerHTML = `${result[3]}`;
     });
...
(function getToken76 () {
           ...
           cryptovideogamestoken.methods.getToken(76).call(function (err, result) {
                ...
                document.getElementById("nextprice76").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard76").innerHTML = `${result[3]}`;
     });
...
(function getToken77 () {
           ...
           cryptovideogamestoken.methods.getToken(77).call(function (err, result) {
                ...
                document.getElementById("nextprice77").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard77").innerHTML = `${result[3]}`;
     });
...
(function getToken78 () {
            ...
            cryptovideogamestoken.methods.getToken(78).call(function (err, result) {
                ...
                document.getElementById("nextprice78").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard78").innerHTML = `${result[3]}`;
     });
...
(function getToken79 () {
           ...
           cryptovideogamestoken.methods.getToken(79).call(function (err, result) {
                ...
                document.getElementById("nextprice79").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard79").innerHTML = `${result[3]}`;
     });
...
(function getToken80 () {
           ...
           cryptovideogamestoken.methods.getToken(80).call(function (err, result) {
                ...
                document.getElementById("nextprice80").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 document.getElementById("ownerCard80").innerHTML = `Owner: <a href="https://retherscan.io/address/${result[3]}"><b style='color:blue'>${result[3].substring(0,12)}...</b></a>`; 
                 document.getElementById("ownermycard80").innerHTML = `${result[3]}`;
     });
...
(function getToken81 () {
           ...
           cryptovideogamestoken.methods.getToken(81).call(function (err, result) {
                ...
                document.getElementById("nextprice81").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard81").innerHTML = `${result[3]}`;
     });
...
(function getToken82 () {
           ...
           cryptovideogamestoken.methods.getToken(82).call(function (err, result) {
                ...
                document.getElementById("nextprice82").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard82").innerHTML = `${result[3]}`;
     });
...
(function getToken83 () {
           ...
           cryptovideogamestoken.methods.getToken(83).call(function (err, result) {
                ...
                document.getElementById("nextprice83").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard83").innerHTML = `${result[3]}`;
     });
...
(function getToken84 () {
           ...
           cryptovideogamestoken.methods.getToken(84).call(function (err, result) {
                ...
                document.getElementById("nextprice84").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard84").innerHTML = `${result[3]}`;
     });
...
(function getToken85 () {
           ...
           cryptovideogamestoken.methods.getToken(85).call(function (err, result) {
                ...
                document.getElementById("nextprice85").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard85").innerHTML = `${result[3]}`;
     });
...
(function getToken86 () {
           ...
           cryptovideogamestoken.methods.getToken(86).call(function (err, result) {
                ...
                document.getElementById("nextprice86").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard86").innerHTML = `${result[3]}`;
     });
...
(function getToken87 () {
           ...
           cryptovideogamestoken.methods.getToken(87).call(function (err, result) {
                ...
                document.getElementById("nextprice87").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard87").innerHTML = `${result[3]}`;
     });
...
(function getToken88 () {
           ...
           cryptovideogamestoken.methods.getToken(88).call(function (err, result) {
                ...
                document.getElementById("nextprice88").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard88").innerHTML = `${result[3]}`;
     });
...
(function getToken89 () {
           ...
           cryptovideogamestoken.methods.getToken(89).call(function (err, result) {
                ...
                document.getElementById("nextprice89").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard89").innerHTML = `${result[3]}`;
     });
...
(function getToken90 () {
           ...
           cryptovideogamestoken.methods.getToken(90).call(function (err, result) {
                ...
                document.getElementById("nextprice90").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard90").innerHTML = `${result[3]}`;
     });
...
(function getToken91 () {
           ...
           cryptovideogamestoken.methods.getToken(91).call(function (err, result) {
                ...
                document.getElementById("nextprice91").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard91").innerHTML = `${result[3]}`;
     });
...
(function getToken92 () {
            ...
            cryptovideogamestoken.methods.getToken(92).call(function (err, result) {
                ...
                document.getElementById("nextprice92").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard92").innerHTML = `${result[3]}`;
     });
...
(function getToken93 () {
            ...
            cryptovideogamestoken.methods.getToken(93).call(function (err, result) {
                ...
                document.getElementById("nextprice93").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard93").innerHTML = `${result[3]}`;
     });
...
(function getToken94 () {
           ...
           cryptovideogamestoken.methods.getToken(94).call(function (err, result) {
                ...
                document.getElementById("nextprice94").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard94").innerHTML = `${result[3]}`;
     });
...
(function getToken95 () {
          ...
          cryptovideogamestoken.methods.getToken(95).call(function (err, result) {
                ...
                document.getElementById("nextprice95").innerHTML = `The next price for this contract is <b>${parseFloat(web3.utils.fromWei(result[2],'ether')).toFixed(3)} ETH<b>`;
                 ...
                 document.getElementById("ownermycard95").innerHTML = `${result[3]}`;
     });
...
// funcion compra Mario Bross TokendId0
    function purchase() {// ejemplo de compra token #0
     cryptovideogamestoken.purchase(0, {value: web3.toWei(document.getElementById('priceOf').value, 'ether')}, function (error, txHash) {
  ...
  <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
  <strong>Success!</strong> His transaction was successful. Transaction Receipt: <a href="https://rinkeby.etherscan.io/tx/${ txHash}"><b style='color:#4CAF50'>${ txHash}</b></a>
<br>
...
function purchase1() {// ejemplo de compra token #1
     cryptovideogamestoken.purchase(1, {value: web3.toWei(document.getElementById('priceOf1').value, 'ether')}, function (error, txHash) {
...
function purchase2() {// ejemplo de compra token #2
     cryptovideogamestoken.purchase(2, {value: web3.toWei(document.getElementById('priceOf2').value, 'ether')}, function (error, txHash) {
...
function purchase3() {// ejemplo de compra token #3
     cryptovideogamestoken.purchase(3, {value: web3.utils.toWei(document.getElementById('priceOf3').value, 'ether')}, function (error, txHash) {
...
function purchase4() {// ejemplo de compra token #4
     cryptovideogamestoken.purchase(4, {value: web3.toWei(document.getElementById('priceOf4').value, 'ether')}, function (error, txHash) {
...
function purchase5() {// ejemplo de compra token #5
     cryptovideogamestoken.purchase(5, {value: web3.toWei(document.getElementById('priceOf5').value, 'ether')}, function (error, txHash) {
...
function purchase6() {// ejemplo de compra token #6
     cryptovideogamestoken.purchase(6, {value: web3.toWei(document.getElementById('priceOf6').value, 'ether')}, function (error, txHash) {
...
function purchase7() {// ejemplo de compra token #7
     cryptovideogamestoken.purchase(7, {value: web3.toWei(document.getElementById('priceOf7').value, 'ether')}, function (error, txHash) {
...
function purchase8() {// ejemplo de compra token #8
     cryptovideogamestoken.purchase(8, {value: web3.toWei(document.getElementById('priceOf8').value, 'ether')}, function (error, txHash) {
...
function purchase9() {// ejemplo de compra token #9
     cryptovideogamestoken.purchase(9, {value: web3.toWei(document.getElementById('priceOf9').value, 'ether')}, function (error, txHash) {
...
function purchase10() {// ejemplo de compra token #10
     cryptovideogamestoken.purchase(10, {value: web3.toWei(document.getElementById('priceOf10').value, 'ether')}, function (error, txHash) {
...
function purchase11() {// ejemplo de compra token #11
     cryptovideogamestoken.purchase(11, {value: web3.toWei(document.getElementById('priceOf11').value, 'ether')}, function (error, txHash) {
...
// funcion compra Sub Zero TokendId12
    function purchase12() {// ejemplo de compra token #12
     cryptovideogamestoken.purchase(12, {value: web3.toWei(document.getElementById('priceOf12').value, 'ether')}, function (error, txHash) {
...
function purchase13() {// ejemplo de compra token #13
     cryptovideogamestoken.purchase(13, {value: web3.toWei(document.getElementById('priceOf13').value, 'ether')}, function (error, txHash) {
...
function purchase14() {// ejemplo de compra token #14
     cryptovideogamestoken.purchase(14, {value: web3.toWei(document.getElementById('priceOf14').value, 'ether')}, function (error, txHash) {
...
function purchase15() {// ejemplo de compra token #15
     cryptovideogamestoken.purchase(15, {value: web3.toWei(document.getElementById('priceOf15').value, 'ether')}, function (error, txHash) {
...
function purchase16() {// ejemplo de compra token #16
     cryptovideogamestoken.purchase(16, {value: web3.toWei(document.getElementById('priceOf16').value, 'ether')}, function (error, txHash) {
...
function purchase17() {// ejemplo de compra token #17
     cryptovideogamestoken.purchase(17, {value: web3.toWei(document.getElementById('priceOf17').value, 'ether')}, function (error, txHash) {
...
function purchase18() {// ejemplo de compra token #18
     cryptovideogamestoken.purchase(18, {value: web3.toWei(document.getElementById('priceOf18').value, 'ether')}, function (error, txHash) {
...
function purchase19() {// ejemplo de compra token #19
     cryptovideogamestoken.purchase(19, {value: web3.toWei(document.getElementById('priceOf19').value, 'ether')}, function (error, txHash) {
...
function purchase20() {// ejemplo de compra token #20
     cryptovideogamestoken.purchase(20, {value: web3.toWei(document.getElementById('priceOf20').value, 'ether')}, function (error, txHash) {
...
function purchase21() {// ejemplo de compra token #21
     cryptovideogamestoken.purchase(21, {value: web3.toWei(document.getElementById('priceOf21').value, 'ether')}, function (error, txHash) {
...
function purchase22() {// ejemplo de compra token #22
     cryptovideogamestoken.purchase(22, {value: web3.toWei(document.getElementById('priceOf22').value, 'ether')}, function (error, txHash) {
...
function purchase23() {// ejemplo de compra token #23
     cryptovideogamestoken.purchase(23, {value: web3.toWei(document.getElementById('priceOf23').value, 'ether')}, function (error, txHash) {
...
function purchase24() {// ejemplo de compra token #24
     cryptovideogamestoken.purchase(24, {value: web3.toWei(document.getElementById('priceOf24').value, 'ether')}, function (error, txHash) {
...
function purchase25() {// ejemplo de compra token #25
     cryptovideogamestoken.purchase(25, {value: web3.toWei(document.getElementById('priceOf25').value, 'ether')}, function (error, txHash) {
...
function purchase26() {// ejemplo de compra token #26
     cryptovideogamestoken.purchase(26, {value: web3.toWei(document.getElementById('priceOf26').value, 'ether')}, function (error, txHash) {
...
function purchase27() {// ejemplo de compra token #27
     cryptovideogamestoken.purchase(27, {value: web3.toWei(document.getElementById('priceOf27').value, 'ether')}, function (error, txHash) {
...
function purchase28() {// ejemplo de compra token #28
     cryptovideogamestoken.purchase(28, {value: web3.toWei(document.getElementById('priceOf28').value, 'ether')}, function (error, txHash) {
...
function purchase29() {// ejemplo de compra token #29
     cryptovideogamestoken.purchase(29, {value: web3.toWei(document.getElementById('priceOf29').value, 'ether')}, function (error, txHash) {
...
function purchase30() {// ejemplo de compra token #30
     cryptovideogamestoken.purchase(30, {value: web3.toWei(document.getElementById('priceOf30').value, 'ether')}, function (error, txHash) {
...
function purchase31() {// ejemplo de compra token #31
     cryptovideogamestoken.purchase(31, {value: web3.toWei(document.getElementById('priceOf31').value, 'ether')}, function (error, txHash) {
...
function purchase32() {// ejemplo de compra token #32
     cryptovideogamestoken.purchase(32, {value: web3.toWei(document.getElementById('priceOf32').value, 'ether')}, function (error, txHash) {
...
function purchase33() {// ejemplo de compra token #33
     cryptovideogamestoken.purchase(33, {value: web3.toWei(document.getElementById('priceOf33').value, 'ether')}, function (error, txHash) {
...
function purchase34() {// ejemplo de compra token #34
     cryptovideogamestoken.purchase(34, {value: web3.toWei(document.getElementById('priceOf34').value, 'ether')}, function (error, txHash) {
...
function purchase35() {// ejemplo de compra token #35
     cryptovideogamestoken.purchase(35, {value: web3.toWei(document.getElementById('priceOf35').value, 'ether')}, function (error, txHash) {
...
function purchase36() {// ejemplo de compra token #36
     cryptovideogamestoken.purchase(36, {value: web3.toWei(document.getElementById('priceOf36').value, 'ether')}, function (error, txHash) {
...
function purchase37() {// ejemplo de compra token #37
     cryptovideogamestoken.purchase(37, {value: web3.toWei(document.getElementById('priceOf37').value, 'ether')}, function (error, txHash) {
...
function purchase38() {// ejemplo de compra token #38
     cryptovideogamestoken.purchase(38, {value: web3.toWei(document.getElementById('priceOf38').value, 'ether')}, function (error, txHash) {
...
function purchase39() {// ejemplo de compra token #39
     cryptovideogamestoken.purchase(39, {value: web3.toWei(document.getElementById('priceOf39').value, 'ether')}, function (error, txHash) {
...
function purchase40() {// ejemplo de compra token #40
     cryptovideogamestoken.purchase(40, {value: web3.toWei(document.getElementById('priceOf40').value, 'ether')}, function (error, txHash) {
...
function purchase41() {// ejemplo de compra token #41
     cryptovideogamestoken.purchase(41, {value: web3.toWei(document.getElementById('priceOf41').value, 'ether')}, function (error, txHash) {
...
function purchase42() {// ejemplo de compra token #42
     cryptovideogamestoken.purchase(42, {value: web3.toWei(document.getElementById('priceOf42').value, 'ether')}, function (error, txHash) {
...
function purchase43() {// ejemplo de compra token #43
     cryptovideogamestoken.purchase(43, {value: web3.toWei(document.getElementById('priceOf43').value, 'ether')}, function (error, txHash) {
...
function purchase44() {// ejemplo de compra token #44
     cryptovideogamestoken.purchase(44, {value: web3.toWei(document.getElementById('priceOf44').value, 'ether')}, function (error, txHash) {
...
function purchase45() {// ejemplo de compra token #45
     cryptovideogamestoken.purchase(45, {value: web3.toWei(document.getElementById('priceOf45').value, 'ether')}, function (error, txHash) {
...
function purchase46() {// ejemplo de compra token #46
     cryptovideogamestoken.purchase(46, {value: web3.toWei(document.getElementById('priceOf46').value, 'ether')}, function (error, txHash) {
...
function purchase47() {// ejemplo de compra token #47
     cryptovideogamestoken.purchase(47, {value: web3.toWei(document.getElementById('priceOf47').value, 'ether')}, function (error, txHash) {
...
function purchase48() {// ejemplo de compra token #48
     cryptovideogamestoken.purchase(48, {value: web3.toWei(document.getElementById('priceOf48').value, 'ether')}, function (error, txHash) {
...
function purchase49() {// ejemplo de compra token #49
     cryptovideogamestoken.purchase(49, {value: web3.toWei(document.getElementById('priceOf49').value, 'ether')}, function (error, txHash) {
...
function purchase50() {// ejemplo de compra token #50
     cryptovideogamestoken.purchase(50, {value: web3.toWei(document.getElementById('priceOf50').value, 'ether')}, function (error, txHash) {
...
function purchase51() {// ejemplo de compra token #51
     cryptovideogamestoken.purchase(51, {value: web3.toWei(document.getElementById('priceOf51').value, 'ether')}, function (error, txHash) {
...
function purchase52() {
     cryptovideogamestoken.purchase(52, {value: web3.toWei(document.getElementById('priceOf52').value, 'ether')}, function (error, txHash) {
...
function purchase53() {
     cryptovideogamestoken.purchase(53, {value: web3.toWei(document.getElementById('priceOf53').value, 'ether')}, function (error, txHash) {
...
function purchase54() {
     cryptovideogamestoken.purchase(54, {value: web3.toWei(document.getElementById('priceOf54').value, 'ether')}, function (error, txHash) {
...
function purchase55() {
     cryptovideogamestoken.purchase(55, {value: web3.toWei(document.getElementById('priceOf55').value, 'ether')}, function (error, txHash) {
...
function purchase56() {
     cryptovideogamestoken.purchase(56, {value: web3.toWei(document.getElementById('priceOf56').value, 'ether')}, function (error, txHash) {
...
function purchase57() {
     cryptovideogamestoken.purchase(57, {value: web3.toWei(document.getElementById('priceOf57').value, 'ether')}, function (error, txHash) {
...
function purchase58() {
     cryptovideogamestoken.purchase(58, {value: web3.toWei(document.getElementById('priceOf58').value, 'ether')}, function (error, txHash) {
...
function purchase59() {
     cryptovideogamestoken.purchase(59, {value: web3.toWei(document.getElementById('priceOf59').value, 'ether')}, function (error, txHash) {
...
function purchase60() {
     cryptovideogamestoken.purchase(60, {value: web3.toWei(document.getElementById('priceOf60').value, 'ether')}, function (error, txHash) {
...
function purchase61() {
     cryptovideogamestoken.purchase(61, {value: web3.toWei(document.getElementById('priceOf61').value, 'ether')}, function (error, txHash) {
...
function purchase62() {
     cryptovideogamestoken.purchase(62, {value: web3.toWei(document.getElementById('priceOf62').value, 'ether')}, function (error, txHash) {
...
function purchase63() {
     cryptovideogamestoken.purchase(63, {value: web3.toWei(document.getElementById('priceOf63').value, 'ether')}, function (error, txHash) {
...
function purchase64() {
     cryptovideogamestoken.purchase(64, {value: web3.toWei(document.getElementById('priceOf64').value, 'ether')}, function (error, txHash) {
...
function purchase65() {
     cryptovideogamestoken.purchase(65, {value: web3.toWei(document.getElementById('priceOf65').value, 'ether')}, function (error, txHash) {
...
function purchase66() {
     cryptovideogamestoken.purchase(66, {value: web3.toWei(document.getElementById('priceOf66').value, 'ether')}, function (error, txHash) {
...
function purchase67() {
     cryptovideogamestoken.purchase(67, {value: web3.toWei(document.getElementById('priceOf67').value, 'ether')}, function (error, txHash) {
...
function purchase68() {
     cryptovideogamestoken.purchase(68, {value: web3.toWei(document.getElementById('priceOf68').value, 'ether')}, function (error, txHash) {
...
function purchase69() {
     cryptovideogamestoken.purchase(69, {value: web3.toWei(document.getElementById('priceOf69').value, 'ether')}, function (error, txHash) {
...
function purchase70() {
     cryptovideogamestoken.purchase(70, {value: web3.toWei(document.getElementById('priceOf70').value, 'ether')}, function (error, txHash) {
...
function purchase71() {
     cryptovideogamestoken.purchase(71, {value: web3.toWei(document.getElementById('priceOf71').value, 'ether')}, function (error, txHash) {
...
function purchase72() {
     cryptovideogamestoken.purchase(72, {value: web3.toWei(document.getElementById('priceOf72').value, 'ether')}, function (error, txHash) {
...
function purchase73() {
     cryptovideogamestoken.purchase(73, {value: web3.toWei(document.getElementById('priceOf73').value, 'ether')}, function (error, txHash) {
...
function purchase74() {
     cryptovideogamestoken.purchase(74, {value: web3.toWei(document.getElementById('priceOf74').value, 'ether')}, function (error, txHash) {
...
function purchase75() {
     cryptovideogamestoken.purchase(75, {value: web3.toWei(document.getElementById('priceOf75').value, 'ether')}, function (error, txHash) {
...
function purchase76() {
     cryptovideogamestoken.purchase(76, {value: web3.toWei(document.getElementById('priceOf76').value, 'ether')}, function (error, txHash) {
...
function purchase77() {
     cryptovideogamestoken.purchase(77, {value: web3.toWei(document.getElementById('priceOf77').value, 'ether')}, function (error, txHash) {
...
function purchase78() {
     cryptovideogamestoken.purchase(78, {value: web3.toWei(document.getElementById('priceOf78').value, 'ether')}, function (error, txHash) {
...
function purchase79() {
     cryptovideogamestoken.purchase(79, {value: web3.toWei(document.getElementById('priceOf79').value, 'ether')}, function (error, txHash) {
...
function purchase80() {
     cryptovideogamestoken.purchase(80, {value: web3.toWei(document.getElementById('priceOf80').value, 'ether')}, function (error, txHash) {
...
function purchase81() {
     cryptovideogamestoken.purchase(81, {value: web3.toWei(document.getElementById('priceOf81').value, 'ether')}, function (error, txHash) {
...
function purchase82() {
     cryptovideogamestoken.purchase(82, {value: web3.toWei(document.getElementById('priceOf82').value, 'ether')}, function (error, txHash) {
...
function purchase83() {
     cryptovideogamestoken.purchase(83, {value: web3.toWei(document.getElementById('priceOf83').value, 'ether')}, function (error, txHash) {
...
function purchase84() {
     cryptovideogamestoken.purchase(84, {value: web3.toWei(document.getElementById('priceOf84').value, 'ether')}, function (error, txHash) {
...
function purchase85() {
     cryptovideogamestoken.purchase(85, {value: web3.toWei(document.getElementById('priceOf85').value, 'ether')}, function (error, txHash) {
...
function purchase86() {
     cryptovideogamestoken.purchase(86, {value: web3.toWei(document.getElementById('priceOf86').value, 'ether')}, function (error, txHash) {
...
function purchase87() {
     cryptovideogamestoken.purchase(87, {value: web3.toWei(document.getElementById('priceOf87').value, 'ether')}, function (error, txHash) {
...
function purchase88() {
     cryptovideogamestoken.purchase(88, {value: web3.toWei(document.getElementById('priceOf88').value, 'ether')}, function (error, txHash) {
...
function purchase89() {
     cryptovideogamestoken.purchase(89, {value: web3.toWei(document.getElementById('priceOf89').value, 'ether')}, function (error, txHash) {
...
function purchase90() {
     cryptovideogamestoken.purchase(90, {value: web3.toWei(document.getElementById('priceOf90').value, 'ether')}, function (error, txHash) {
...
function purchase91() {
     cryptovideogamestoken.purchase(91, {value: web3.toWei(document.getElementById('priceOf91').value, 'ether')}, function (error, txHash) {
...
function purchase92() {
     cryptovideogamestoken.purchase(92, {value: web3.toWei(document.getElementById('priceOf92').value, 'ether')}, function (error, txHash) {
...
function purchase93() {
     cryptovideogamestoken.purchase(93, {value: web3.toWei(document.getElementById('priceOf93').value, 'ether')}, function (error, txHash) {
...
function purchase94() {
     cryptovideogamestoken.purchase(94, {value: web3.toWei(document.getElementById('priceOf94').value, 'ether')}, function (error, txHash) {
...
function purchase95() {
     cryptovideogamestoken.purchase(95, {value: web3.toWei(document.getElementById('priceOf95').value, 'ether')}, function (error, txHash) {
